...
/*
-(void)cellContains:(Class) xoroView {
	if ([xoroView isEqual:XView]){
		[self.tapView setContains:[XView class]];
	}
	else if ([xoroView isEqual:OView]) {
		[self.tapView setContains:[OView class]];
	}
}
*/
